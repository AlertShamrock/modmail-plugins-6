...
class ReportUser(commands.Cog):
    ...
    async def report(
        ...
        if self.channel is None:
            ...
            embed=discord.Embed(title="Report", description="Thank you for your report! Our Management team will look into it soon", color=0x00ff80)         
    ...
    async def on_raw_reaction_add(self, payload: discord.RawReactionActionEvent):
        ...
        embed=discord.Embed(title=f"**Reply from Management Team**", description=reportr.content, color=0x0080ff)             
